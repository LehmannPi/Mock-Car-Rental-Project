...
insert into veiculo (id_veiculo, den_veiculo, ano, marca, preco, cor) values (5, 'cras pellentesque volutpat dui maecenas tristique', 2008, 'Mazda', 170, 'Fuscia');
...
insert into veiculo (id_veiculo, den_veiculo, ano, marca, preco, cor) values (8, 'nonummy maecenas tincidunt lacus at velit', 1988, 'Mitsubishi', 872, 'Yellow');
...
insert into veiculo (id_veiculo, den_veiculo, ano, marca, preco, cor) values (20, 'penatibus et magnis dis parturient montes', 2011, 'Kia', 830, 'Goldenrod');
...
insert into cliente (id_cliente, endereco, contato, nome_cliente) values (5, 'nulla suscipit ligula in lacus curabitur', '6436767638', 'Saundra Beveridge');
